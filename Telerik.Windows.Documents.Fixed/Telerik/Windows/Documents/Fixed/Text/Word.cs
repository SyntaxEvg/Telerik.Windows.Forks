...
namespace Telerik.Windows.Documents.Fixed.Text
{
	class Word
	{
		...
		{
			WordPosition item = CollectionsExtensions.FindElement<WordPosition, double>(this.positions, location, new CompareDelegate<WordPosition, double>(Word.CompareWithWordPosition));
