...
{
	class SetLineJoin : ContentStreamOperator
	{
		...
		public override void Execute(ContentStreamInterpreter interpreter, IPdfContentImportContext context)
		{
			...
			interpreter.GraphicState.StrokeLineJoin = (LineJoin)last.Value;
		}

		public void Write(PdfWriter writer, IPdfContentExportContext context, LineJoin lineJoin)
		{
			PdfInt pdfInt = new PdfInt((int)lineJoin);
