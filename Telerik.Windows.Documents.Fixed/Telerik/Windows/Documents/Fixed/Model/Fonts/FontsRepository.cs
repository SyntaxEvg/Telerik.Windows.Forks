...
namespace Telerik.Windows.Documents.Fixed.Model.Fonts
{
	public static class FontsRepository
	{
		...
		static void RegisterStandartFontCreators()
		{
		...
		static void RegisterStandartFonts()
		{
		...
		static StandardFont CreateStandardFont(string fontName, double ascent, double descent, double lineGap, bool isBold, bool isItalic)
		{
		...
		static void RegisterFont(FontProperties fontProperties, FontBase font)
		{
		...
		static void RegisterStandardFontCreator(string fontName, double ascent, double descent, double lineGap, bool isBold, bool isItalic)
		{
		...
		static StandardFont CreateStandardFontByName(string fontName)
		{
			return FontsRepository.standardFontCreators[fontName]();
		}

		static FontBase CreateFont(FontProperties fontProperties, byte[] data)
		{
		...
		static FontBase CreateFontFromTrueTypeCollection(FontProperties fontProperties, TrueTypeCollection trueTypeCollection)
		{
		...
		static FontBase CreateFontFromOpenTypeFontSource(OpenTypeFontSource fontSource)
		{
			return new CidType2Font(FontsRepository.CreateFontName(fontSource), fontSource);
		}

		static string CreateFontName(OpenTypeFontSource fontSource)
		{
		...
		const double HelveticaDescent = -211.0;

		const double HelveticaAscent = 905.0;

		const double HelveticaLineGap = 32.0;

		const double TimesDescent = -216.0;

		const double TimesAscent = 891.0;

		const double TimesLineGap = 42.0;

		const double CourierDescent = -300.0;

		const double CourierAscent = 832.0;

		const double CourierLineGap = 0.0;

		const double SymbolDescent = -219.0;

		const double SymbolAscent = 1005.0;

		const double SymbolLineGap = 0.0;

		const double ZapfDingbatsDescent = -220.0;

		const double ZapfDingbatsAscent = 1000.0;

		const double ZapfDingbatsLineGap = 0.0;

		static readonly object lockObject = new object();

		static readonly Dictionary<FontProperties, FontBase> fontPropertiesToFont = new Dictionary<FontProperties, FontBase>();

		static readonly Dictionary<string, Func<StandardFont>> standardFontCreators = new Dictionary<string, Func<StandardFont>>();

		static readonly StandardFont helvetica;

		static readonly StandardFont helveticaBold;

		static readonly StandardFont helveticaOblique;

		static readonly StandardFont helveticaBoldOblique;

		static readonly StandardFont courier;

		static readonly StandardFont courierBold;

		static readonly StandardFont courierOblique;

		static readonly StandardFont courierBoldOblique;

		static readonly StandardFont timesRoman;

		static readonly StandardFont timesBold;

		static readonly StandardFont timesItalic;

		static readonly StandardFont timesBoldItalic;

		static readonly StandardFont symbol;

		static readonly StandardFont zapfDingbats;
	}
}
