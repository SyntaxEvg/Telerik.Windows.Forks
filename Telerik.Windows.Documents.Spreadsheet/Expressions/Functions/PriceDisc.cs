...
namespace Telerik.Windows.Documents.Spreadsheet.Expressions.Functions
{
	public class PriceDisc : NumbersInFunction
	{
		...
		public override FunctionInfo FunctionInfo
		{
			get
			{
				return PriceDisc.Info;
			}
		}

		static PriceDisc()
		{
			string description = "Returns the price per $100 face value of a discounted security.";
			string descriptionLocalizationKey = "Spreadsheet_Functions_PriceDisc_Info";
			IEnumerable<ArgumentInfo> requiredArgumentsInfos = new ArgumentInfo[]
			{
				...
				new ArgumentInfo("Discount", "is the security's discount rate.", ArgumentType.Number, true, "Spreadsheet_Functions_Args_Discount", "Spreadsheet_Functions_PriceDisc_DiscountInfo"),
			...
			PriceDisc.Info = new FunctionInfo(PriceDisc.FunctionName, FunctionCategory.Financial, description, requiredArgumentsInfos, optionalArgumentsInfos, 1, false, descriptionLocalizationKey);
		}
		...
		protected override RadExpression EvaluateOverride(FunctionEvaluationContext<double> context)
		{
			...
			try
			{
				number = FinancialFunctions.PRICEDISC(dateTime.Value, dateTime2.Value, num, num2, num3);
			}
			catch (Exception)
			{
				return ErrorExpressions.NumberError;
		...
		public static readonly string FunctionName = "PRICEDISC";
