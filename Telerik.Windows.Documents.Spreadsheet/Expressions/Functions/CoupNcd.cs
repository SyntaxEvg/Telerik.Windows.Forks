...
{
	public class CoupNcd : NumbersInFunction
	{
		...
		static CoupNcd()
		{
			string description = "Returns a number that represents the next coupon date after the settlement date.";
			string descriptionLocalizationKey = "Spreadsheet_Functions_CoupNcd_Info";
			...
			CoupNcd.Info = new FunctionInfo(CoupNcd.FunctionName, FunctionCategory.Financial, description, requiredArgumentsInfos, optionalArgumentsInfos, 1, false, descriptionLocalizationKey);
		}
		...
		protected override RadExpression EvaluateOverride(FunctionEvaluationContext<double> context)
		{
			...
			try
			{
				DateTime dateTime3 = FinancialFunctions.COUPNCD(dateTime.Value, dateTime2.Value, num, num2);
		...
		public static readonly string FunctionName = "COUPNCD";
