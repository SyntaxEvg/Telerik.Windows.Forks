...
{
	public class CumPrinc : NumbersInFunction
	{
		...
		public override FunctionInfo FunctionInfo
		{
			get
			{
				return CumPrinc.Info;
			}
		}

		static CumPrinc()
		{
			string description = "Returns the cumulative principal paid on a loan between start_period and end_period.";
			string descriptionLocalizationKey = "Spreadsheet_Functions_CumPrinc_Info";
			...
			CumPrinc.Info = new FunctionInfo(CumPrinc.FunctionName, FunctionCategory.Financial, description, requiredArgumentsInfos, false, descriptionLocalizationKey);
		}
		...
		protected override RadExpression EvaluateOverride(FunctionEvaluationContext<double> context)
		{
			...
			try
			{
				number = FinancialFunctions.CUMPRINC(num, num2, num3, num4, num5, num6);
			}
			catch (Exception)
			{
				return ErrorExpressions.NumberError;
		...
		public static readonly string FunctionName = "CUMPRINC";
