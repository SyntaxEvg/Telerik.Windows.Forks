...
namespace Telerik.Windows.Documents.Spreadsheet.Expressions.Functions
{
	public class YieldDisc : NumbersInFunction
	{
		...
		static YieldDisc()
		{
			...
			string descriptionLocalizationKey = "Spreadsheet_Functions_YieldDisc_Info";
			...
			YieldDisc.Info = new FunctionInfo(YieldDisc.FunctionName, FunctionCategory.Financial, description, requiredArgumentsInfos, optionalArgumentsInfos, 1, false, descriptionLocalizationKey);
		}
		...
		protected override RadExpression EvaluateOverride(FunctionEvaluationContext<double> context)
		{
			...
			try
			{
				number = FinancialFunctions.YIELDDISC(dateTime.Value, dateTime2.Value, num, num2, num3);
			}
			catch (Exception)
			{
				return ErrorExpressions.NumberError;
		...
		public static readonly string FunctionName = "YIELDDISC";
