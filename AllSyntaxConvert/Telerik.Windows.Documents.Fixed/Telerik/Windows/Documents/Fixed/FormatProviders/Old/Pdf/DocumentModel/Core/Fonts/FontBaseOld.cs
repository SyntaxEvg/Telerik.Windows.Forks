...
namespace Telerik.Windows.Documents.Fixed.FormatProviders.Old.Pdf.DocumentModel.Core.Fonts
{
	abstract class FontBaseOld : PdfObjectOld
	{
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::Telerik.Windows.Documents.Fixed.Model.Internal.GlyphOld> GetGlyphs(global::Telerik.Windows.Documents.Fixed.FormatProviders.Old.Pdf.DocumentModel.Data.PdfStringOld str)
		{
			if (str != null && str.Value != null)
			{
				if (this.Mapping != null)
				{
					global::System.Collections.Generic.IEnumerable<global::Telerik.Windows.Documents.Core.Data.Tuple<string, global::Telerik.Windows.Documents.Fixed.Model.Internal.Classes.CharCodeOld>> text = this.Mapping.ToUnicode(str.Value);
					foreach (global::Telerik.Windows.Documents.Core.Data.Tuple<string, global::Telerik.Windows.Documents.Fixed.Model.Internal.Classes.CharCodeOld> p in text)
					{
						yield return new global::Telerik.Windows.Documents.Fixed.Model.Internal.GlyphOld
						{
							CharId = p.Item2,
							ToUnicode = p.Item1
						};
				...
				else
				{
					...
					{
						global::Telerik.Windows.Documents.Fixed.Model.Internal.GlyphOld glyphOld = new global::Telerik.Windows.Documents.Fixed.Model.Internal.GlyphOld();
						glyphOld.CharId = new global::Telerik.Windows.Documents.Fixed.Model.Internal.Classes.CharCodeOld(b);
						global::Telerik.Windows.Documents.Fixed.Model.Internal.GlyphOld glyphOld2 = glyphOld;
						char c = (char)b;
