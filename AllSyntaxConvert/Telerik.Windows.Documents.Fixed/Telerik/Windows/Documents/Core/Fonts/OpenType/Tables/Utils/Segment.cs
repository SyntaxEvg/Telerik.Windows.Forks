...
namespace Telerik.Windows.Documents.Core.Fonts.OpenType.Tables.Utils
{
	class Segment
	{
		...
		public bool Contains(ushort glyphId)
		{
			...
			ushort num = (ushort)(this.startCode + (ushort)this.idDelta);
			ushort num2 = (ushort)(this.endCode + (ushort)this.idDelta);
		...
		internal ushort GetCharId(ushort glyphId)
		{
			if (this.map != null)
			{
				return (ushort)(this.startCode + this.map.GetFromValue((ushort)(glyphId - (ushort)this.idDelta)));
			}
			return (ushort)(glyphId - (ushort)this.idDelta);
		}
		...
		public bool TryGetGlyphId(int unicode, out ushort glyphId)
		{
			...
			if (this.map != null)
			{
				...
				glyphId = (ushort)(this.map.GetToValue(num) + (ushort)this.idDelta);
			}
			else
			{
