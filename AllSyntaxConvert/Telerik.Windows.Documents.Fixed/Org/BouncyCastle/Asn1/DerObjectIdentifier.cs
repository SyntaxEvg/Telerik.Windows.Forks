...
{
	class DerObjectIdentifier : Asn1Object
	{
		...
		void WriteField(Stream outputStream, long fieldValue)
		{
		...
		void WriteField(Stream outputStream, BigInteger fieldValue)
		{
		...
		static string MakeOidStringFromBytes(byte[] bytes)
		{
		...
		const long LONG_LIMIT = 72057594037927808L;
