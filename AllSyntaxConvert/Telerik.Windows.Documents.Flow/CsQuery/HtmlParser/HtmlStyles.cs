	...
	static class HtmlStyles
	{
		static HtmlStyles()
		{
			...
			foreach (object obj in xmlNodeList)
			{
				...
				if ((key = value) != null)
				{
					if (PImplD_E95A4CFF6AEE4974AC65107846A83AB8.method0x6000e311 == null)
					{
						PImplD_E95A4CFF6AEE4974AC65107846A83AB8.method0x6000e311 = new Dictionary<string, int>(8)
						{
							{ "length", 0 },
							{ "color", 1 },
							{ "composite", 2 },
					...
					int num;
					if (PImplD_E95A4CFF6AEE4974AC65107846A83AB8.method0x6000e311.TryGetValue(key, out num))
					{
						switch (num)
						{
						case 0:
