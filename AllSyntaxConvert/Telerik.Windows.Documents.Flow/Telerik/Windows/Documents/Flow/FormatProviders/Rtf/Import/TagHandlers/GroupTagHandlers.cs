...
namespace Telerik.Windows.Documents.Flow.FormatProviders.Rtf.Import.TagHandlers
{
	static class GroupTagHandlers
	{
		...
		static bool HeaderFooterHandler(RtfGroup group, RtfImportContext context)
		{
			...
			{
				if (PImplD_E95A4CFF6AEE4974AC65107846A83AB8.method0x6001e001 == null)
				{
					PImplD_E95A4CFF6AEE4974AC65107846A83AB8.method0x6001e001 = new Dictionary<string, int>(8)
					{
						{ "header", 0 },
						{ "headerr", 1 },
						{ "headerf", 2 },
				...
				int num;
				if (PImplD_E95A4CFF6AEE4974AC65107846A83AB8.method0x6001e001.TryGetValue(destination, out num))
				{
