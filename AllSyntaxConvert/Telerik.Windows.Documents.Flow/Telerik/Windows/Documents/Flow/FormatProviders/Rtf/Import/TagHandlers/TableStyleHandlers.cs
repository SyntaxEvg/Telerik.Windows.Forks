...
namespace Telerik.Windows.Documents.Flow.FormatProviders.Rtf.Import.TagHandlers
{
	static class TableStyleHandlers
	{
		...
		static void RowBordersHandler(RtfTag tag, RtfImportContext context)
		{
			...
			{
				if (PImplD_E95A4CFF6AEE4974AC65107846A83AB8.method0x6001e5c1 == null)
				{
					PImplD_E95A4CFF6AEE4974AC65107846A83AB8.method0x6001e5c1 = new Dictionary<string, int>(6)
					{
						{ "trbrdrt", 0 },
						{ "trbrdrl", 1 },
						{ "trbrdrb", 2 },
				...
				int num;
				if (PImplD_E95A4CFF6AEE4974AC65107846A83AB8.method0x6001e5c1.TryGetValue(name, out num))
				{
					switch (num)
					{
					case 0:
		...
		static void CellBordersHandler(RtfTag tag, RtfImportContext context)
		{
			...
			if ((name = tag.Name) != null)
			{
				if (PImplD_E95A4CFF6AEE4974AC65107846A83AB8.method0x6001e5d1 == null)
				{
					PImplD_E95A4CFF6AEE4974AC65107846A83AB8.method0x6001e5d1 = new Dictionary<string, int>(6)
					{
						{ "clbrdrt", 0 },
						{ "clbrdrl", 1 },
						{ "clbrdrb", 2 },
				...
				int num;
				if (PImplD_E95A4CFF6AEE4974AC65107846A83AB8.method0x6001e5d1.TryGetValue(name, out num))
				{
					switch (num)
					{
					case 0:
		...
		static void CellSettingsHandler(RtfTag tag, RtfImportContext context)
		{
			...
			if ((name = tag.Name) != null)
			{
				if (PImplD_E95A4CFF6AEE4974AC65107846A83AB8.method0x6001e5e1 == null)
				{
					PImplD_E95A4CFF6AEE4974AC65107846A83AB8.method0x6001e5e1 = new Dictionary<string, int>(23)
					{
						{ "clvertalt", 0 },
						{ "tsvertalt", 1 },
						{ "clvertalc", 2 },
				...
				int num;
				if (PImplD_E95A4CFF6AEE4974AC65107846A83AB8.method0x6001e5e1.TryGetValue(name, out num))
				{
					switch (num)
					{
					case 0:
