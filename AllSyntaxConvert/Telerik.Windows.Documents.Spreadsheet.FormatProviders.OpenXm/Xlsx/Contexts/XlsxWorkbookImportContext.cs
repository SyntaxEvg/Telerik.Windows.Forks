...
namespace Telerik.Windows.Documents.Spreadsheet.FormatProviders.OpenXml.Xlsx.Contexts
{
	class XlsxWorkbookImportContext : XlsxWorkbookContextBase<XlsxWorksheetImportContext>, IXlsxWorkbookImportContext, IOpenXmlImportContext
	{
		public XlsxWorkbookImportContext()
			: base(false, new global::Telerik.Windows.Documents.Spreadsheet.Model.Workbook())
		{
			this.resourcesMapping = new global::System.Collections.Generic.Dictionary<string, global::Telerik.Windows.Documents.Common.Model.Data.IResource>();
			this.formats = new global::Telerik.Windows.Documents.Spreadsheet.FormatProviders.OpenXml.Xlsx.Contexts.DifferentialFormatsImportContext();
			this.axesGroupNamesToAxesIndices = new global::Telerik.Windows.Documents.Core.Data.ValueMapper<global::Telerik.Windows.Documents.Model.Drawing.Charts.AxisGroupName, global::System.Tuple<int, int>>();
			this.seriesGroupsToAxesIndices = new global::Telerik.Windows.Documents.Core.Data.ValueMapper<global::Telerik.Windows.Documents.Model.Drawing.Charts.ISupportAxes, global::System.Tuple<int, int>>();
		}
		...
		public void RegisterSeriesGroupAwaitingAxisGroupName(global::Telerik.Windows.Documents.Model.Drawing.Charts.ISupportAxes seriesGroup, int catAxisId, int valAxisId)
		{
			this.seriesGroupsToAxesIndices.AddPair(seriesGroup, new global::System.Tuple<int, int>(catAxisId, valAxisId));
		}

		public void RegisterAxisGroup(global::Telerik.Windows.Documents.Model.Drawing.Charts.AxisGroupName groupName, int thisId, int otherId)
		{
			if (!this.axesGroupNamesToAxesIndices.ContainsFromValue(groupName))
			{
				this.axesGroupNamesToAxesIndices.AddPair(groupName, new global::System.Tuple<int, int>(thisId, otherId));
			}
		}

		public void PairSeriesGroupsWithAxes()
		{
			foreach (global::Telerik.Windows.Documents.Model.Drawing.Charts.ISupportAxes supportAxes in this.seriesGroupsToAxesIndices.FromValues)
			{
				global::System.Tuple<int, int> expectedIndices = this.seriesGroupsToAxesIndices.GetToValue(supportAxes);
				global::System.Tuple<int, int> tuple = this.axesGroupNamesToAxesIndices.ToValues.FirstOrDefault((global::System.Tuple<int, int> registeredPair) => (expectedIndices.Item1 == registeredPair.Item1 && expectedIndices.Item2 == registeredPair.Item2) || (expectedIndices.Item1 == registeredPair.Item2 && expectedIndices.Item2 == registeredPair.Item1));
				if (tuple == null)
				{
					throw new global::System.InvalidOperationException("The axes are incorrectly paired.");
				}
				global::Telerik.Windows.Documents.Model.Drawing.Charts.AxisGroupName fromValue = this.axesGroupNamesToAxesIndices.GetFromValue(tuple);
		...
		private global::Telerik.Windows.Documents.Core.Data.ValueMapper<global::Telerik.Windows.Documents.Model.Drawing.Charts.AxisGroupName, global::System.Tuple<int, int>> axesGroupNamesToAxesIndices;

		private global::Telerik.Windows.Documents.Core.Data.ValueMapper<global::Telerik.Windows.Documents.Model.Drawing.Charts.ISupportAxes, global::System.Tuple<int, int>> seriesGroupsToAxesIndices;
	}
}
