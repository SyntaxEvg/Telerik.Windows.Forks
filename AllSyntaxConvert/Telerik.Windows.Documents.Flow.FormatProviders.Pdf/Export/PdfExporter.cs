...
using Extensions = Telerik.Windows.Documents.Flow.FormatProviders.Pdf.Utils.Extensions;
...
namespace Telerik.Windows.Documents.Flow.FormatProviders.Pdf.Export
{
	class PdfExporter
	{
		...
		private static void ExportWatermark(global::Telerik.Windows.Documents.Fixed.Model.Editing.Flow.SectionInfo sectionInfo, global::Telerik.Windows.Documents.Flow.Model.Watermarks.WatermarkCollection watermarks)
		{
			foreach (object obj in watermarks)
			{
				global::Telerik.Windows.Documents.Flow.Model.Watermarks.Watermark watermark = (global::Telerik.Windows.Documents.Flow.Model.Watermarks.Watermark)obj;
				switch (watermark.WatermarkType)
				{
					case global::Telerik.Windows.Documents.Flow.Model.Watermarks.WatermarkType.Image:
						{
							global::Telerik.Windows.Documents.Fixed.Model.Editing.Flow.ImageWatermarkSettings imageWatermarkSettings = new global::Telerik.Windows.Documents.Fixed.Model.Editing.Flow.ImageWatermarkSettings();
							imageWatermarkSettings.CopyPropertiesFrom(watermark.ImageSettings);
							sectionInfo.InsertWatermark(imageWatermarkSettings);
							break;
						}
					case global::Telerik.Windows.Documents.Flow.Model.Watermarks.WatermarkType.Text:
						{
							global::Telerik.Windows.Documents.Fixed.Model.Editing.Flow.TextWatermarkSettings textWatermarkSettings = new global::Telerik.Windows.Documents.Fixed.Model.Editing.Flow.TextWatermarkSettings();
		...
		IEnumerable<IBlockElement> ExportBlockContainer(BlockContainerBase blockContainer, RadFixedDocumentEditor editor = null)
		{
			...
			{
				IBlockElement blockElement = this.ExportBlock(editor, blockContainer.Blocks[i], i == last ? (BlockBase)null : blockContainer.Blocks[i + 1], i == 0);
