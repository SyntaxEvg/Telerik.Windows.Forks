...
namespace Telerik.Windows.Documents.Spreadsheet.Expressions.Functions
{
	public class CoupDaysNc : NumbersInFunction
	{
		...
		public override string Name
		{
			get
			{
				return CoupDaysNc.FunctionName;
			}
		}
		...
		public override FunctionInfo FunctionInfo
		{
			get
			{
				return CoupDaysNc.Info;
			}
		}

		static CoupDaysNc()
		{
			string description = "Returns the number of days from the settlement date to the next coupon date.";
			string descriptionLocalizationKey = "Spreadsheet_Functions_CoupDaysNc_Info";
			...
			CoupDaysNc.Info = new FunctionInfo(CoupDaysNc.FunctionName, FunctionCategory.Financial, description, requiredArgumentsInfos, optionalArgumentsInfos, 1, false, descriptionLocalizationKey);
		}
		...
		protected override RadExpression EvaluateOverride(FunctionEvaluationContext<double> context)
		{
			...
			try
			{
				number = FinancialFunctions.COUPDAYSNC(dateTime.Value, dateTime2.Value, num, num2);
			}
			catch (Exception)
			{
				return ErrorExpressions.NumberError;
		...
		public static readonly string FunctionName = "COUPDAYSNC";
