...
{
	public class CoupDayBs : NumbersInFunction
	{
		...
		public override FunctionInfo FunctionInfo
		{
			get
			{
				return CoupDayBs.Info;
			}
		}

		static CoupDayBs()
		{
			string description = "Returns the number of days from the beginning of a coupon period until its settlement date.";
			string descriptionLocalizationKey = "Spreadsheet_Functions_CoupDayBs_Info";
			...
			CoupDayBs.Info = new FunctionInfo(CoupDayBs.FunctionName, FunctionCategory.Financial, description, requiredArgumentsInfos, optionalArgumentsInfos, 1, false, descriptionLocalizationKey);
		}
		...
		protected override RadExpression EvaluateOverride(FunctionEvaluationContext<double> context)
		{
			...
			try
			{
				number = FinancialFunctions.COUPDAYSBS(dateTime.Value, dateTime2.Value, num, num2);
			}
			catch (Exception)
			{
				return ErrorExpressions.NumberError;
		...
		public static readonly string FunctionName = "COUPDAYBS";
