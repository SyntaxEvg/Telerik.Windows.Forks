...
{
	public class CoupNum : NumbersInFunction
	{
		...
		static CoupNum()
		{
			string description = "Returns the number of coupons payable between the settlement date and maturity date, rounded up to the nearest whole coupon.";
			string descriptionLocalizationKey = "Spreadsheet_Functions_CoupNum_Info";
			...
			CoupNum.Info = new FunctionInfo(CoupNum.FunctionName, FunctionCategory.Financial, description, requiredArgumentsInfos, optionalArgumentsInfos, 1, false, descriptionLocalizationKey);
		}
		...
		protected override RadExpression EvaluateOverride(FunctionEvaluationContext<double> context)
		{
			...
			try
			{
				number = FinancialFunctions.COUPNUM(dateTime.Value, dateTime2.Value, num, num2);
			}
			catch (Exception)
			{
				return ErrorExpressions.NumberError;
		...
		public static readonly string FunctionName = "COUPNUM";
