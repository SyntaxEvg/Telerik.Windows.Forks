...
namespace Telerik.Windows.Documents.Spreadsheet.Expressions
{
	public class GreaterThanOrEqualToExpression : ComparisonOperatorExpression
	{
		...
		public GreaterThanOrEqualToExpression(RadExpression left, RadExpression right)
			: base(left, right)
		{
		}
		...
		{
			return new GreaterThanOrEqualToExpression(base.Left.CloneAndTranslate(context), base.Right.CloneAndTranslate(context));
		}
