...
namespace Telerik.Windows.Documents.Spreadsheet.PropertySystem
{
	class CellsPropertyBag : WorksheetPropertyBagBase
	{
		...
		{
			this.suspendPropertyChangedCounter = new global::Telerik.Windows.Documents.Spreadsheet.Core.BeginEndCounter();
			this.changedProperties = new global::System.Collections.Generic.HashSet<global::Telerik.Windows.Documents.Spreadsheet.PropertySystem.IPropertyDefinition>();
			this.sortCounter = new global::Telerik.Windows.Documents.Spreadsheet.Core.BeginEndCounter(new global::System.Action(this.OnSortCompleted));
			this.sortedRanges = new global::System.Collections.Generic.HashSet<global::Telerik.Windows.Documents.Spreadsheet.Model.CellRange>();
			this.RegisterProperty<global::Telerik.Windows.Documents.Spreadsheet.Model.ICellValue>(global::Telerik.Windows.Documents.Spreadsheet.PropertySystem.CellPropertyDefinitions.ValueProperty);
			this.RegisterProperty<global::Telerik.Windows.Documents.Spreadsheet.Model.DataValidation.IDataValidationRule>(global::Telerik.Windows.Documents.Spreadsheet.PropertySystem.CellPropertyDefinitions.DataValidationRuleProperty);
		}
		...
		{
			Telerik.Windows.Documents.Spreadsheet.Utilities.Guard.ThrowExceptionIfNull<CellRange>(cellRange, "cellRange");
			long fromIndex = WorksheetPropertyBagBase.ConvertCellIndexToLong(cellRange.FromIndex);
			long toIndex = WorksheetPropertyBagBase.ConvertCellIndexToLong(cellRange.ToIndex);
		...
		{
			Telerik.Windows.Documents.Spreadsheet.Utilities.Guard.ThrowExceptionIfNull<CellIndex>(cellIndex, "cellIndex");
		...
		{
			Telerik.Windows.Documents.Spreadsheet.Utilities.Guard.ThrowExceptionIfNull<CellIndex>(cellIndex, "index");
		...
		{
			Telerik.Windows.Documents.Spreadsheet.Utilities.Guard.ThrowExceptionIfNull<CellRange>(cellRange, "range");
			foreach (LongRange longRange in WorksheetPropertyBagBase.ConvertCellRangeToLongRanges(cellRange))
			{
		...
		{
			Telerik.Windows.Documents.Spreadsheet.Utilities.Guard.ThrowExceptionIfNull<IPropertyDefinition<T>>(property, "property");
			Telerik.Windows.Documents.Spreadsheet.Utilities.Guard.ThrowExceptionIfNull<ICompressedList>(values, "values");
		...
		{
			Telerik.Windows.Documents.Spreadsheet.Utilities.Guard.ThrowExceptionIfNull<CellRange>(cellRange, "cellRange");
			Telerik.Windows.Documents.Spreadsheet.Utilities.Guard.ThrowExceptionIfNull<Func<T, T>>(newValueTransform, "newValueTransform");
			foreach (LongRange longRange in WorksheetPropertyBagBase.ConvertCellRangeToLongRanges(cellRange))
			{
		...
		{
			Telerik.Windows.Documents.Spreadsheet.Utilities.Guard.ThrowExceptionIfNull<CellPropertyChangedEventArgs>(args, "args");
			if (this.suspendPropertyChangedCounter.IsUpdateInProgress)
			{
		...
		{
			Telerik.Windows.Documents.Spreadsheet.Utilities.Guard.ThrowExceptionIfNull<SortedEventArgs>(args, "args");
			if (this.Sorted != null)
			{
		...
		private readonly global::Telerik.Windows.Documents.Spreadsheet.Core.BeginEndCounter suspendPropertyChangedCounter;

		readonly HashSet<IPropertyDefinition> changedProperties;

		private readonly global::Telerik.Windows.Documents.Spreadsheet.Core.BeginEndCounter sortCounter;
