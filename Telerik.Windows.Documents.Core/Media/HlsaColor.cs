...
namespace Telerik.Windows.Documents.Media
{
	class HlsaColor
	{
		...
		public static HlsaColor FromColor(Color color)
		{
		...
		public static Color ToColor(HlsaColor color)
		{
			...
			if (num3 == 0.0)
			{
				return Color.FromArgb((byte)MathUtilities.Clamp(num4 * 255.0, 0.0, 255.0, 5), (byte)MathUtilities.Clamp(num2 * 255.0, 0.0, 255.0, 5), (byte)MathUtilities.Clamp(num2 * 255.0, 0.0, 255.0, 5), (byte)MathUtilities.Clamp(num2 * 255.0, 0.0, 255.0, 5));
			}
			double num5;
			if (num2 <= 0.5)
			{
			...
			return Color.FromArgb((byte)MathUtilities.Clamp(num4 * 255.0, 0.0, 255.0, 5), (byte)MathUtilities.Clamp(num6 * 255.0, 0.0, 255.0, 5), (byte)MathUtilities.Clamp(num7 * 255.0, 0.0, 255.0, 5), (byte)MathUtilities.Clamp(num8 * 255.0, 0.0, 255.0, 5));
		}

		public static bool operator ==(HlsaColor instance1, HlsaColor instance2)
		{
			return object.ReferenceEquals(instance1, instance2) || (instance1 != null && instance2 != null && HlsaColor.AreEqual(instance1, instance2));
		}
		...
		{
			return HlsaColor.AreEqual(this, otherInstance);
		}
